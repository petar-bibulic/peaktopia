...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-24">
      <div className="relative flex place-items-center before:-translate-x-1/2 after:translate-x-1/3 before:lg:h-[200px]">
        <h1 className="text-3xl font-bold">Welcome to Peaktopia</h1>
      </div>
      <div className="w-full items-center justify-between font-mono text-sm mb-4">
